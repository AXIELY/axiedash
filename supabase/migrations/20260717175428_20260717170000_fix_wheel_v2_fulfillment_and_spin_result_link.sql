-- Fix: execute_wheel_spins now:
-- 1. Stores spin result FIRST, captures spin_result_id
-- 2. Links reward_grants to spin_result_id
-- 3. Creates fulfillment_cases for MANUAL_SERVICE/VIP_ACCESS/GRAND_PRIZE prizes
--    so they appear in "جوائزي" (My Prizes)
...
BEGIN
  ...
  FOR v_i IN 1..p_spin_count LOOP
    ...
    INSERT INTO wheel_v2_spin_results (
      ...
      NULL, -- will be updated after reward grant creation
